...
HD_PWD='C:/CSEE4280Workpace/final_Project/uartTransmit_vivado/vivado/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log topMod.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source topMod.tcl
