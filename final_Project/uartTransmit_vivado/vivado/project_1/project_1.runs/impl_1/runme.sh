...
HD_PWD='C:/CSEE4280Workpace/final_Project/uartTransmit_vivado/vivado/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log topMod.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source topMod.tcl -notrace
