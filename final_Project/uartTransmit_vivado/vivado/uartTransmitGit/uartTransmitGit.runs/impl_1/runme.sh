...
HD_PWD='C:/CSEE4280Workpace/final_Project/uartTransmit_vivado/vivado/uartTransmitGit/uartTransmitGit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log topModuleUART.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source topModuleUART.tcl -notrace
