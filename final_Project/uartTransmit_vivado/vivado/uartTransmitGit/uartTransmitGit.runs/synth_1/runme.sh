...
HD_PWD='C:/CSEE4280Workpace/final_Project/uartTransmit_vivado/vivado/uartTransmitGit/uartTransmitGit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log topModuleUART.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source topModuleUART.tcl
